    ...
    <div class="col-md-9 col-lg-8">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb bg-transparent p-0" style="font-size: 14px;">
                ...
                <li class="breadcrumb-item active" aria-current="page" style="color: var(--text-muted);">Thêm sản phẩm</li>
            </ol>
        </nav>
        ...
        <div class="card premium-card border-0 p-4">
            <div class="border-bottom pb-3 mb-4">
                <h1 class="h4 font-weight-bold mb-1" style="color: var(--text-main); letter-spacing: -0.5px;">
                    <i class="fa-solid fa-circle-plus mr-2 text-primary"></i>Thêm sản phẩm mới
                </h1>
                <p class="text-muted mb-0" style="font-size: 13px;">Nhập đầy đủ thông tin bên dưới để đăng tải điện thoại mới lên gian hàng</p>
            </div>
            ...
            <div class="card-body p-0">
                ...
                <form method="POST" action="<?php echo BASE_URL; ?>/Product/save" enctype="multipart/form-data">
                    <div class="form-group mb-4">
                        ...
                        <input type="text" id="name" name="name" class="form-control form-control-lg border" placeholder="Ví dụ: iPhone 15 Pro Max" style="border-radius: var(--radius-sm); font-size: 15px;" required>
                    </div>
                    
                    <div class="form-group mb-4">
                        <label for="description" class="font-weight-bold text-secondary small text-uppercase mb-2">Mô tả chi tiết sản phẩm:</label>
                        <textarea id="description" name="description" class="form-control border" rows="5" placeholder="Thông tin về thiết kế, hiệu năng, camera, dung lượng pin..." style="border-radius: var(--radius-sm); font-size: 14px;" required></textarea>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    <input type="number" id="price" name="price" class="form-control border" placeholder="Ví dụ: 30990000" style="border-radius: var(--radius-sm) 0 0 var(--radius-sm); font-size: 15px;" required>
                    ...
                    <div class="form-group mb-4">
                        <label for="image" class="font-weight-bold text-secondary small text-uppercase mb-2">Ảnh đại diện sản phẩm:</label>
                        <div class="custom-file mb-2" style="height: 50px;">
                            ...
                            <label class="custom-file-label d-flex align-items-center" for="image" style="height: 50px; border-radius: var(--radius-sm); font-size: 14px; color: var(--text-muted);">
                                <i class="fa-regular fa-image mr-2 text-primary" style="font-size: 18px;"></i>Chọn hình ảnh sản phẩm...
                            </label>
                        </div>
                        <div class="text-center my-2 text-muted font-weight-bold small">- HOẶC NHẬP ĐƯỜNG DẪN ẢNH (URL) -</div>
                        <input type="text" id="image_url" name="image_url" class="form-control border" placeholder="Nhập liên kết ảnh trực tuyến (ví dụ: https://example.com/iphone.jpg)" style="border-radius: var(--radius-sm); font-size: 14px; padding: 12px 15px; height: auto;">
                    </div>
